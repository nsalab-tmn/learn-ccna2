...
<!-- 4.2.2 -->
## S1 Сети VLAN и конфигурации магистральных каналов
...
<!-- 4.2.7 -->
## Packet Tracer. Настройка маршрутизации между сетями VLAN с использованием конфигурации router-on-a-stick
...
[Открыть описание в PDF](./assets/4.2.7.pdf)

[Скачать файл для Packet Tracer](./assets/4.2.7.pka)
...
[Открыть описание в PDF](./assets/4.2.8.pdf)