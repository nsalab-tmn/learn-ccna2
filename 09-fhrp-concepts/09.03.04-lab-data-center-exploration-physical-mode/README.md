...
Часть 1. Изучите характеристики небольшого центра обработки данных.

Часть 2. Создайте план расширения текущего центра обработки данных.

Часть 3. Настройте устройства центра обработки данных для расширения емкости.

## Общие сведения и сценарий

Центры обработки данных часто называют мозгом организации, хранящим и анализирующим данные, обеспечивая коммуникацию как внутри компании, так и клиентам, а также предоставляя инструменты, необходимые для исследований и разработок. Центр обработки данных должен быть построен таким образом, чтобы он мог безопасно и эффективно предоставлять полный спектр продуктов и услуг, независимо от того, что может произойти. Есть много различных систем, которые входят в строительство центра обработки данных, но мы будем заниматься только сетевой частью.

Эти центры могут состоять из нескольких серверов или сотен и даже тысяч серверов. Независимо от размера, центр обработки данных должен быть построен максимально четко, чтобы упростить управление и устранение неполадок в сложной среде. Другой конструктивной особенностью является повышение надежности за счет использования резерва для устранения любой точки отказа. Это может включать добавление дополнительных устройств для обеспечения физического резервирования и/или использование таких технологий, как протоколы резервирования первого перехода (FHRP) и агрегация каналов для обеспечения логического резерва.
...
**Примечание.** **Rack** сокращается как **R**, а **Server** сокращается как **S**.

Ответьте на вопрос №8

Ответьте на вопрос №9

**Шаг 3. Изучите резервную технологию уровня 2 для центров обработки данных**

Проверьте **DC1 R0 Switch A** и **DC1 R0 Switch B**.

Перейдите в **Data Center 1 Server Room** в **Toronto**. В **Rack_0**выберите **DC1 R0 Switch A** \> вкладку **CLI** и **DC1 R0 Switch B** \> вкладку **CLI** . Выровняйте окна бок о бок.
...
**Примечание.** Убедитесь, что имена узлов соответствуют стандарту. Packet Tracer оценит ваши подключения и конфигурацию как неправильные, если отображаемые имена неверны.
...
3.  Щелкните второй коммутатор в **Rack_5**, а затем – на вкладку **Config**.
 ...
 **Примечание.** Сделаейте оба канала до **DC1-R5S1**, прежде чем перейти к стойке.
