...
<!--
показывает топологию с маршрутизатором, подключенным к коммутатору, подключенному к хост-компьютеру
-->
...
<!--
показано, что при SLAAC только у маршрутизатора установлен флаг A в 1 
-->
...
На рисунке показан ПК, отправляющий сообщение RS на адрес многоадресной рассылки всех маршрутизаторов и получающий RA в ответ.
