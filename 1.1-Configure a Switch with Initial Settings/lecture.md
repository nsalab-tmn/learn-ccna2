...
![](./assets/1.1.3.png)
<!-- /courses/srwe-dl/af9ea780-34fe-11eb-b1b2-9b1b0c1f7e0d/afb58ae1-34fe-11eb-b1b2-9b1b0c1f7e0d/assets/c956e980-1c27-11ea-af09-3b2e6521927c.svg -->

<!--
На рисунке показаны светодиодные индикаторы, кнопка режима и порты на передней левой стороне коммутатора. Светодиодные индикаторы, пронумерованные 1 - 6 сверху вниз: SYST, RPS, STAT, DUPLX, SPEED и PoE. Под светодиодными индикаторами и помечены 7 на рисунке находится кнопка режима. Над коммутаторными портами и помечены 8 на рисунке являются светодиоды портов.
-->
...
![](./assets/1.1.5.png)
<!-- /courses/srwe-dl/af9ea780-34fe-11eb-b1b2-9b1b0c1f7e0d/afb58ae1-34fe-11eb-b1b2-9b1b0c1f7e0d/assets/c9593372-1c27-11ea-af09-3b2e6521927c.svg -->
...
<!-- 1.1.7 -->
## Работа в симуляторе: базовая настройка коммутатора
