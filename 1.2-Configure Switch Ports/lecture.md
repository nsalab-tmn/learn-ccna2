...
Команда s**how running-config** может использоваться для проверки правильности настройки коммутатора. Из выборки сокращенного вывода по S1 на рисунке показана некоторая важная информация:
...
<!-- 1.2.9 -->
## Проверка синтаксиса - Настройка портов коммутатора