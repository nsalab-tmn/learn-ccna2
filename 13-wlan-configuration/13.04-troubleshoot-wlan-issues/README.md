...
<!-- 13.4.5 -->
## Работа в симуляторе: поиск и устранение неполадок WLAN сетей.
...
[Поиск и устранение проблем с беспроводными локальными сетями (pdf)](./assets/13.4.5-packet-tracer---troubleshoot-wlan-issues_ru-RU.pdf)

[Поиск и устранение проблем с беспроводными локальными сетями (pka)](./assets/13.4.5-packet-tracer---troubleshoot-wlan-issues_ru-RU.pka)