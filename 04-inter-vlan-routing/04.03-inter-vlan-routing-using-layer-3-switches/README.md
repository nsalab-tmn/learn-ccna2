...
Современные корпоративные сети редко используют метод ROS, так как он масштабируется не так просто, чтобы соответствовать требованиям. В этих очень больших сетях администраторы сети используют коммутаторы уровня 3 для настройки маршрутизации между VLAN.
