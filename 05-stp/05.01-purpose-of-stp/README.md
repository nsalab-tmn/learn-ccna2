...
<!--
На этой анимации показана так же топология, что и в предыдущей анимации. Заблокированных портов нет. PC1 отправляет широковещательный кадр. S2 обновляет таблицу MAC-адресов. MAC-адрес ПК 1 сопоставляется с f0-/11. S2 пересылает широковещательную передачу на все порты, кроме принимающего. S3 и S1 обновляют свои таблицы информацией PC1. S3 и S1 перенаправляют широковещательную передачу на все порты, кроме принимающего, и получают пакет от PC1 на новый порт. Они соответствующим образом обновляют свою таблицу MAC-адресов. S1 и S3 перенаправляют широковещательную передачу на все порты, кроме принимающего. S2 обновляет свою таблицу MAC-адресов для PC1 последним портом, на который он получил широковещательный кадр. S2 пересылает широковещательный кадр на все порты, кроме последнего принятого. Цикл начинается снова.
-->
