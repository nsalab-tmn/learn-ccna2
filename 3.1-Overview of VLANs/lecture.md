...
| Повышение безопасности | - Только пользователи одной и той же сети VLAN могут общаться вместе. - На рисунке, сетевой трафик факультета на VLAN 10 полностью отделен и защищен от пользователей в других VLAN. Улучшена эффективность ИТ-инфраструктуры |
