...
<!-- 1.5.7 -->
## Проверка синтаксиста - Фильтрация выходных данных команды show
...
<!-- 1.5.9 -->
## Проверка синтаксиса - Особенности истории команд
...
<!-- 1.5.11 -->
## Проверить ваше понимание темы — проверить непосредственно подключенные сети