...
| 4 | Разработка плана действий по устранению неполадки и его реализация решение | После того, как вы определили точную причину проблемы, составьте план действий для решения проблемы и внедрите решение.  | 
...
На рисунке показана топология сети с беспроводным клиентом, который не может подключиться к точке доступа. На рисунке показан маршрутизатор, подключенный к коммутатору. Коммутатор подключен ко второму коммутатору. Второй коммутатор подключен к WLC, 2 ПК и точке доступа. Точка доступа беспроводно связывается с сотовым телефоном, планшетом и ноутбуком. Однако у подключения ноутбука к точке доступа есть X, указывающее, что соединение не было установлено.

![](./assets/13.4.2.PNG)

<!-- /courses/srwe-dl/af9ef5a0-34fe-11eb-b1b2-9b1b0c1f7e0d/afb7adca-34fe-11eb-b1b2-9b1b0c1f7e0d/assets/cab938a0-1c27-11ea-af09-3b2e6521927c.svg -->
...
На рисунке показана домашняя сеть, разделяющая трафик между 2,4 ГГц и 5 ГГц. WLC подключен к телевизору, сотовому телефону и планшету с использованием 5 ГГц. Он также подключен к двум ноутбукам с использованием 2,4 ГГц.

![](./assets/13.4.3.PNG)

<!-- /courses/srwe-dl/af9ef5a0-34fe-11eb-b1b2-9b1b0c1f7e0d/afb7adca-34fe-11eb-b1b2-9b1b0c1f7e0d/assets/cab9add1-1c27-11ea-af09-3b2e6521927c.svg -->
...
По умолчанию двухдиапазонные маршрутизаторы и точки доступа используют одно и то же имя сети как в диапазоне 2,4 ГГц, так и в диапазоне 5 ГГц. Самый простой способ сегментировать трафик - это переименовать одну из беспроводных сетей. При наличии отдельного описательного имени гораздо проще подключиться к нужной сети.
...
На беспроводном контроллере Cisco 3504 Wireless Controller, Нажмите следующие пункты меню **WIRELESS** tab > **Access Points** from the left menu > **Global Configuration**. Затем прокрутите страницу вниз до раздела «Предварительная загрузка образа AP».
...
<!--13.4.5-->
## Packet Tracer. Поиск и устранение неполадок WLAN сетей.
...
[Открыть описание в PDF](./assets/13.4.5-packet-tracer---troubleshoot-wlan-issues_ru-RU.pdf)

[Скачать файл для Packet Tracer](./assets/13.4.5-packet-tracer---troubleshoot-wlan-issues_ru-RU.pka)
